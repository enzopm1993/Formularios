...
using Asiservy.Automatizacion.Formularios.AccesoDatos.CALIDAD.TemperaturaInternaRefrigeradora;
...
{
    public class TemperaturaInternaRefrigeradoraController : Controller
    {

        private ClsdTemperaturaInternaRefrigeradora ClsdTemperaturaInternaRefrigeradora { get; set; } = null;
        ...
        // GET: TemperaturaInternaRefrigeradora
        #region CONTROL 
        [Authorize]
        ...
        [HttpPost]
        public ActionResult TemperaturaInternaRefrigeradora(CC_TEMPERATURA_INTERNA_REFRIGERADORA model, DateTime Fecha)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
               if (!User.Identity.IsAuthenticated)
                ...
                ClsdTemperaturaInternaRefrigeradora.GuardarModificarTemperaturaInternaRefrigeradora(model, Fecha);
        ...
        public ActionResult TemperaturaInternaRefrigeradoraPartial(DateTime Fecha)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
               if (!User.Identity.IsAuthenticated)
                ...
                ClsdTemperaturaInternaRefrigeradora = new ClsdTemperaturaInternaRefrigeradora();
                var model = ClsdTemperaturaInternaRefrigeradora.ConsultaTemperaturaInternaRefrigeradora(Fecha);
                if (!model.Any())
                {
        ...
        public JsonResult ValidaEstadoReporte(DateTime Fecha)
        {
            try
            {
               ...
               if (!User.Identity.IsAuthenticated)
                ...
                ClsdTemperaturaInternaRefrigeradora = new ClsdTemperaturaInternaRefrigeradora();
                var control = ClsdTemperaturaInternaRefrigeradora.ConsultaTemperaturaInternaRefrigeradoraControl(Fecha).FirstOrDefault();
                if (control != null)
                {
        ...
        [Authorize]
        public ActionResult BandejaTemperaturaInternaRefrigeradora()
        {
            try
            {
                ViewBag.dataTableJS = "1";
        ...
        public ActionResult BandejaTemperaturaInternaRefrigeradoraPartial(DateTime? FechaDesde, DateTime? FechaHasta, bool Estado = false)
        {
            try
            {
                ClsdTemperaturaInternaRefrigeradora = new ClsdTemperaturaInternaRefrigeradora();
                List<CC_TEMPERATURA_INTERNA_REFRIGERADORA_CONTROL> poCloroCisterna = null;
                if (FechaDesde != null && FechaHasta != null)
                {
                    poCloroCisterna = ClsdTemperaturaInternaRefrigeradora.ConsultaTemperaturaInternaRefrigeradoraControl(FechaDesde.Value, FechaHasta.Value, Estado);
                }
                else
                {
                    poCloroCisterna = ClsdTemperaturaInternaRefrigeradora.ConsultaTemperaturaInternaRefrigeradoraControlPendiente();
        ...
        public ActionResult BandejaAprobarTemperaturaInternaRefrigeradora(DateTime fecha)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
               if (!User.Identity.IsAuthenticated)
                ...
                ClsdTemperaturaInternaRefrigeradora = new ClsdTemperaturaInternaRefrigeradora();
                var poCloroCisterna = ClsdTemperaturaInternaRefrigeradora.ConsultaTemperaturaInternaRefrigeradora(fecha);
                if (poCloroCisterna != null && poCloroCisterna.Any())
                {
        ...
        public ActionResult AprobarBandejaControlCloro(CC_TEMPERATURA_INTERNA_REFRIGERADORA_CONTROL model)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
        ...
        #region REPORTE 
        [Authorize]
        public ActionResult ReporteTemperaturaInternaRefrigeradora()
        {
            try
            {
                ViewBag.JavaScrip = "CALIDAD/" + RouteData.Values["controller"] + "/" + RouteData.Values["action"];
                ...
                lsUsuario = User.Identity.Name.Split('_');
                var usuarioOpcion = clsDLogin.ValidarPermisoOpcion(lsUsuario[1], "TemperaturaInternaRefrigeradora");
                if (usuarioOpcion)
                {
                    ViewBag.Link = "../" + RouteData.Values["controller"] + "/" + "TemperaturaInternaRefrigeradora";
                }
                else ViewBag.Link = null;
                return View();
            }
        ...
        public ActionResult ReporteTemperaturaInternaRefrigeradoraPartial(DateTime FechaDesde, DateTime FechaHasta)
        {
            try
            {
                ClsdTemperaturaInternaRefrigeradora = new ClsdTemperaturaInternaRefrigeradora();
                List<spReporteTemperaturaInternaRefrigeradora> poControl = null;

                poControl = ClsdTemperaturaInternaRefrigeradora.ConsultaTemperaturaInternaRefrigeradoraControl(FechaDesde, FechaHasta);
        ...
        public ActionResult ReporteTemperaturaInternaRefrigeradoraDetallePartial(DateTime Fecha)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
