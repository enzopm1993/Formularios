...
namespace Asiservy.Automatizacion.Formularios.Controllers.CALIDAD
{
    public class ResidualCloroController : Controller
    {
        ...
        public ActionResult ResidualCloroDetallePartial(int IdControl)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
        ...
        public ActionResult EliminarResidualCloroDetalle(RESIDUAL_CLORO_DETALLE model, DateTime Fecha, string Area)
        {
            try
            {
                ...
                if (model.IdResidualCloroDetalle == 0)
                {
                    return Json("0", JsonRequestBehavior.AllowGet);
                }
                model.FechaIngresoLog = DateTime.Now;
        ...
        public ActionResult ReporteResidualCloroControlPartial(DateTime FechaDesde, DateTime FechaHasta)
        {
            try
            {
                clsDResidualCloro = new clsDResidualCloro();
                List<RESIDUAL_CLORO_CONTROL> poControl = null;
                clsDClasificador = new clsDClasificador();
                ViewBag.Areas = clsDClasificador.ConsultarClasificador(clsAtributos.CodGrupoAreasResidualCloro);
                poControl = clsDResidualCloro.ConsultaResidualCloroControl(FechaDesde, FechaHasta);
        ...
        public ActionResult BandejaResidualCloro()
        {
            try
            {
                ViewBag.dataTableJS = "1";
        ...
        public ActionResult AprobarBandejaControlCloro(RESIDUAL_CLORO_CONTROL model)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
                ...
                model.TerminalIngresoLog = Request.UserHostAddress;
                model.UsuarioIngresoLog = lsUsuario[0];
                clsDResidualCloro.Aprobar_ReporteResidualCloro(model);
        ...
        public ActionResult ReversarBandejaControlCloro(RESIDUAL_CLORO_CONTROL model)
        {
            try
            {
                lsUsuario = User.Identity.Name.Split('_');
                ...
                model.AprobadoPor = string.Empty;
