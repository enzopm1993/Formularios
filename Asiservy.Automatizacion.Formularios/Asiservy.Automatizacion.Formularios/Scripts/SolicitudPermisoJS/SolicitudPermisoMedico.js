...
function CambioDepartamento(valor) {
    ...
    //    new Array(1, 1, "-	Maternidad"),
    //    new Array(1, 2, "-	Descanso médico"),
    //    new Array(1, 3, "-	Citas médicas (IESS/M.S.P.)"),
...
//    $("#selectGrupoEnfermedad").combobox();
//    $("#toggle").on("click", function () {
//        $("#selectGrupoEnfermedad").toggle();
//    });
//});

//fin combo autocomplete
