...
function CargarBandeja() {
    ...
    $.ajax({
        url: "../CloroAguaAutoclave/BandejaCloroAguaAutoclavePartial",
        type: "GET",
...
function SeleccionarBandeja(model) {
    // console.log(model);
  //  CargarControlDetalle(model.IdCloroAguaAutoclave);
...
function AprobarControl() {
    ...
    $.ajax({
        url: "../CloroAguaAutoclave/AprobarBandejaControlCloro",
        type: "POST",
        data: {
...
function ReversarControl() {
    //var estadoReporte = data;
    $.ajax({
        url: "../CloroAguaAutoclave/ReversarBandejaControl",
        type: "POST",
        data: {
            IdCloroAguaAutoclave: listaDatos.IdCloroAguaAutoclave,
            Fecha: listaDatos.Fecha,
