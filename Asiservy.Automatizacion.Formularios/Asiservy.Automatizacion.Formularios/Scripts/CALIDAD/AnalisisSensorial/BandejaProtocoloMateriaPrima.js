...
function CargarBandeja() {
    ...
    $.ajax({
        url: "../AnalisisSensorial/BandejaProtocoloMateriaPrimaPartial",
        type: "GET",
...
function AprobarControl() {
    ...
    $.ajax({
        url: "../AnalisisSensorial/AprobarBandejaControl",
        type: "POST",
        data: {
            IdAnalisisSensorial: listaDatos.IdAnalisisSensorial,
...
function ReversarControl() {
    //var estadoReporte = data;
    $.ajax({
        url: "../AnalisisSensorial/ReversarBandejaControl",
        type: "POST",
        data: {
            IdAnalisisSensorial: listaDatos.IdAnalisisSensorial,
            Fecha: listaDatos.Fecha
