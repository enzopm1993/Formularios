...
function CargarBandeja() {
    ...
    $.ajax({
        url: "../LimpiezaDesinfeccionPlanta/BandejaLimpiezaPlantaPartial",
        data: {
...
function SeleccionarBandeja(model) {
    ...
    var op = 1;
    $.ajax({
        url: "../LimpiezaDesinfeccionPlanta/BandejaLimpiezaPlantaAprobarPartial",
        type: "GET",
        data: {            
...
function SeleccionarBandejaOnChange() {   
    var op = 1;
    $.ajax({
        url: "../LimpiezaDesinfeccionPlanta/BandejaLimpiezaPlantaAprobarPartial",
        type: "GET",
        ...
        success: function (resultado) {
            ...
            if (resultado == "0") {
                $("#divAprobarPendientePartial").html("No existen registros");
            } else {
                $("#tblAprobarPendientePartial").html('');
                $("#ModalApruebaPendiente").modal("show");
                $("#divAprobarPendientePartial").html(resultado);
