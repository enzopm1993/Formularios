...
function CargarBandeja() {
    ...
    $.ajax({
        url: "../AnalisisAguaTanquero/BandejaAnalisisAguaTanqueroPartial",
        type: "GET",
...
function SeleccionarBandeja(model) {
    // console.log(model);
    //  CargarControlDetalle(model.IdAnalisisAguaTanquero);
...
function AprobarControl() {
    ...
    $.ajax({
        url: "../AnalisisAguaTanquero/AprobarBandejaControlCloro",
        type: "POST",
        data: {
            IdAnalisisAguaTanquero: listaDatos.IdAnalisisAguaTanquero,
...
function ReversarControl() {
    //var estadoReporte = data;
    $.ajax({
        url: "../AnalisisAguaTanquero/ReversarBandejaControl",
        type: "POST",
        data: {
            IdAnalisisAguaTanquero: listaDatos.IdAnalisisAguaTanquero,
            Fecha: listaDatos.Fecha
