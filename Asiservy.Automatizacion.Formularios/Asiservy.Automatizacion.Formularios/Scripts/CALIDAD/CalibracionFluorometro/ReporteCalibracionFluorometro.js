...
function CargarCabecera(op) {
    ...
    $.ajax({
        url: "../CalibracionFluorometro/ReporteCalibracionFluorometroPartial",
        data: {
...
//    $.ajax({
//        url: "../CalibracionFluorometro/ReporteCalibracionFluorometroPartail",//MUESTRO EL DETALLE DE LA FILA SELECCIONADA
//        data: {
//            fechaDesde: $("#fechaDesde").val(),
//            fechaHasta: $("#fechaHasta").val(),
