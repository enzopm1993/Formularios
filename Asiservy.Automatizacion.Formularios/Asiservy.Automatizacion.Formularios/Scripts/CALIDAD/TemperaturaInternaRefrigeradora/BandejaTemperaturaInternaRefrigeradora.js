...
function CargarBandeja() {
    ...
    $.ajax({
        url: "../TemperaturaInternaRefrigeradora/BandejaTemperaturaInternaRefrigeradoraPartial",
        type: "GET",
...
function SeleccionarBandeja(model) {
    // console.log(model);
    //  CargarControlDetalle(model.IdTemperaturaInternaRefrigeradora);
...
function AprobarControl() {
    ...
    $.ajax({
        url: "../TemperaturaInternaRefrigeradora/AprobarBandejaControlCloro",
        type: "POST",
        data: {
            IdTemperaturaInternaRefrigeradora: listaDatos.IdTemperaturaInternaRefrigeradora,
...
function ReversarControl() {
    //var estadoReporte = data;
    $.ajax({
        url: "../TemperaturaInternaRefrigeradora/ReversarBandejaControl",
        type: "POST",
        data: {
            IdTemperaturaInternaRefrigeradora: listaDatos.IdTemperaturaInternaRefrigeradora,
            Fecha: listaDatos.Fecha
...
function CargarControlDetalle() {
    ...
    $.ajax({
        url: "../TemperaturaInternaRefrigeradora/ReporteTemperaturaInternaRefrigeradoraDetallePartial",
        type: "GET",
        data: {
            Fecha: listaDatos.Fecha
