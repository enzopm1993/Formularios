...
function CargarBandeja() {
    ...
    $.ajax({
        url: "../AnalisisAguaCalderos/BandejaAnalisisAguaCalderosPartial",
        type: "GET",
...
function SeleccionarBandeja(model) {
    // console.log(model);
    //  CargarControlDetalle(model.IdAnalisisAguaCalderos);
...
function AprobarControl() {
    ...
    $.ajax({
        url: "../AnalisisAguaCalderos/AprobarBandejaControl",
        type: "POST",
        data: {
            IdAnalisisAguaCalderos: listaDatos.IdAnalisisAguaCalderos,
...
function ReversarControl() {
    //var estadoReporte = data;
    $.ajax({
        url: "../AnalisisAguaCalderos/ReversarBandejaControl",
        type: "POST",
        data: {
            IdAnalisisAguaCalderos: listaDatos.IdAnalisisAguaCalderos,
            Fecha: listaDatos.Fecha
