...
function GuardarControl() {
    ...
    //    $("#SelectTipoLimpieza").css('borderCParametroAac', '#FA8072');
    //    return;
    //} else {
    //    $("#SelectTipoLimpieza").css('borderCParametroAac', '#ced4da');
    //}

    if ($("#txtDescripcion").val() == "") {
        $("#txtDescripcion").css('borderCParametroAac', '#FA8072');
        return;
    } else {
        $("#txtDescripcion").css('borderCParametroAac', '#ced4da');
    }

    if ($("#txtAbreviatura").val() == "") {
        $("#txtAbreviatura").css('borderCParametroAac', '#FA8072');
        return;
    } else {
        $("#txtAbreviatura").css('borderCParametroAac', '#ced4da');
    }
